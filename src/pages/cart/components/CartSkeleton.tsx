...
const CartSkeleton = () => {
    return <>
        ...
        >
            ...
            <header className="flex items-center py-4 px-2 justify-between border-b h-[5%]">
                <button className="cursor-pointer hover:bg-gray-300 rounded-full h-8 w-8" aria-label="Close">✕</button>
